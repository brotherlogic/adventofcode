%%%-------------------------------------------------------------------
%% @doc Client module for grpc service adventofcode.AdventOfCodeService.
%% @end
%%%-------------------------------------------------------------------

%% this module was generated and should not be modified manually

-module(adventofcode_advent_of_code_service_client).
...
-define(SERVICE, 'adventofcode.AdventOfCodeService').
...
solve(Ctx, Input, Options) ->
    grpcbox_client:unary(Ctx, <<"/adventofcode.AdventOfCodeService/Solve">>, Input, ?DEF(solve_request, solve_response, <<"adventofcode.SolveRequest">>), Options).
