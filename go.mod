module github.com/brotherlogic/adventofcode

go 1.18

require (
	github.com/brotherlogic/adventserver v0.0.0-20230216035145-72f5bbb295dd
...
require (
	...
	github.com/brotherlogic/rstore v0.17.0 // indirect
